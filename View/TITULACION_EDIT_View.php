...
//-------------------------------------------------------
// Creación del formulario que enseña los datos del TITULACION y permite editarlos

	class TITULACION_EDIT{


		function __construct($tupla,$CENTROS){	
			$this->tupla = $tupla;
		...
		?>
			...
			<form name = 'Form' action='../Controller/TITULACION_Controller.php' method='post' onsubmit="return comprobar_entrada_titulaciones();">
					...
					<p data-lang='Nombre de la Titulación'>Nombre de la Titulación</p><input type = 'text' name = 'NOMBRETITULACION' id = 'NOMBRETITULACION' placeholder = '' size = '50' value = '<?php echo $this->tupla['NOMBRETITULACION']; ?>'onblur="comprobarVacio('NOMBRETITULACION')  && comprobarAlfabetico('NOMBRETITULACION',50)"><br>

					<p data-lang='Responsable de la Titulación'>Responsable de la Titulación</p><input type = 'text' name = 'RESPONSABLETITULACION' id = 'RESPONSABLETITULACION' placeholder = '' size = '50' value = '<?php echo $this->tupla['RESPONSABLETITULACION']; ?>' onblur="comprobarVacio('RESPONSABLETITULACION')  && comprobarAlfabetico('RESPONSABLETITULACION',60)"><br>
					<br><br>
