...
//-------------------------------------------------------
// Crea una tabla que permite añadir, buscar, eliminar, editar y ver en detalle todos los PROF_ESPACIOS o los que se han pasado como parámetro. 
...
?>
			...
			<a href='../Controller/PROF_ESPACIO_Controller.php?action=ADD'><img src="../View/Images/plus.png" width="50" height="50"></a>              <a href='../Controller/PROF_ESPACIO_Controller.php?action=SEARCH'><img src="../View/Images/search.png" width="50" height="50"/></a>
			<br>
				...
				<td>
					<a href='
						../Controller/PROF_ESPACIO_Controller.php?action=EDIT&CODESPACIO=
							<?php echo $fila['CODESPACIO']; ?>&DNI=<?php echo $fila['DNI']; ?>
